...
parser.add_argument("-c", "--dir", help = "Specify config dir")
parser.add_argument("-i", "--interval", help = "Specify interval")
parser.add_argument("-d", "--start_day", help = "Specify start day of month")
...
r.make_sql(args.interval, args.start_year, args.start_month, args.start_day)
r.run_job()
